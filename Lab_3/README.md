...
| В появившемся выпадающем списке нажать на пункт "Линия тренда". | Выпадающий список исчез. Вместо стандартного указателя мыши пользователя появился указатель в виде черного круга. |
